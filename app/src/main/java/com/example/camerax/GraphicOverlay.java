...
public class GraphicOverlay extends View {
   ...
   * instances to the overlay using {@link com.example.camerax.GraphicOverlay#add(Graphic)}.
   */
  public abstract static class Graphic {
    private com.example.camerax.GraphicOverlay overlay;

    public Graphic(com.example.camerax.GraphicOverlay overlay) {
